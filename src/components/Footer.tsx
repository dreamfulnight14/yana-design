        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-300 max-w-xs">
              Premium rewards for premium customers. Amplify your experience with every purchase.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Cookie Settings</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap justify-center md:justify-end gap-4">
              <a href="#" className="flex items-center gap-2 bg-white/10 hover:bg-white/20 transition-colors px-4 py-2 rounded-lg">
          ...
          <p className="text-gray-400 text-center mt-8">© 2025 Origins Enterprises LLC. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
