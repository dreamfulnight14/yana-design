				...
				<div className="flex flex-col items-center space-y-8 text-center">
					...
					<div className="space-y-4">
						...
						<p className="text-xl text-gray-700 md:text-2xl/relaxed lg:text-2xl/relaxed xl:text-2xl/relaxed mx-auto max-w-3xl">
							Earn exclusive savings and perks every time you shop. Three tiers,
							more rewards, and the easiest way to save at Origins.
						</p>
					</div>
					<div className="flex flex-col sm:flex-row gap-3 md:gap-4">
						...
						<Button
							variant="outline"
							className="border-purple-700 text-purple-700 hover:bg-purple-50 text-base font-medium px-8 py-2.5 h-auto"
						>
							Learn More
						</Button>
					</div>
						...
						<div className="flex flex-wrap justify-center gap-8">
							<div className="flex items-center gap-2">
								<div className="w-10 h-10 rounded-full flex items-center justify-center bg-purple-100">
									...
									>
										<path
											d="M12 21V12M12 8V3M5 12H3M5 4.22l2 2M19 12h2M19 19.78l-2-2M19 4.22l-2 2M5 19.78l2-2M12.71 7.29a1 1 0 11-1.42 1.42 1 1 0 011.42-1.42z"
											strokeWidth="1.5"
											strokeLinecap="round"
							...
							<div className="flex items-center gap-2">
								<div className="w-10 h-10 rounded-full flex items-center justify-center bg-amber-100">
									...
									>
										...
										/>
										<path
											d="M20 4v16H4V4h16m0-2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"
											strokeWidth="1.5"
											strokeLinecap="round"
											strokeLinejoin="round"
										/>
							...
							<div className="flex items-center gap-2">
								<div className="w-10 h-10 rounded-full flex items-center justify-center bg-purple-100">
									...
									>
										<path
											d="M19 14c1.49-.7 2.5-2.27 2.5-4 0-2.21-1.79-4-4-4-.95 0-1.81.35-2.5.9M14.5 10a3.5 3.5 0 11-7 0 3.5 3.5 0 017 0zM16.5 2h5v5M12 20H4v-1c0-1.1.9-2 2-2h6c1.1 0 2 .9 2 2v1z"
											strokeWidth="1.5"
											strokeLinecap="round"
											strokeLinejoin="round"
										/>
