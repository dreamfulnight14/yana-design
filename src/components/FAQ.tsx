						...
						<Accordion type="single" collapsible className="w-full">
							<AccordionItem value="item-1" className="">
								...
								<AccordionContent className="text-gray-600">
									Every $1 you spend (pre-tax) = 1 point. Visit often and watch
									your rewards grow!
								</AccordionContent>
							</AccordionItem>
							<AccordionItem value="item-2" className="">
								...
								<AccordionContent className="text-gray-600">
									Smooth & Mellow 20% OFF rewards expire after 90 days. Heavy
									Hitter and OG discounts last until March 1, 2027.
								</AccordionContent>
							</AccordionItem>
							...
							<AccordionItem value="item-4" className="">
								<AccordionTrigger className="text-left text-gray-800">
									What's the benefit of higher tiers?
								</AccordionTrigger>
								<AccordionContent className="text-gray-600">
									Heavy Hitters get 20% OFF every purchase, OGs get 30% OFF
									every purchase—until March 1, 2027!
								</AccordionContent>
							</AccordionItem>
							<AccordionItem value="item-5" className="">
								...
								<AccordionContent className="text-gray-600">
									Loyalty rewards cannot be combined with other promotional
									discounts, but they can be used on sale items.
								</AccordionContent>
							</AccordionItem>
						</Accordion>
					</div>
